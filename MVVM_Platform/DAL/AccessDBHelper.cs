...
namespace DAL
{
    public class AccessDBHelper: IDatabase
    {
        public static string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["AccessConStr"].ToString();
        public static object _syncObject = new object();//多线程同步
        ...
        //    object obj = AccessDBHelper.GetSingleResult(strsql);
        //    if (obj == null)
        //    {
        //        return -1;
        //    }
        ...
        //{
        //    object obj = AccessDBHelper.GetSingle(strSql);
        //    int cmdresult;
        ...
        //{
        //    object obj = AccessDBHelper.GetSingle(strSql, cmdParms);
        //    int cmdresult;
        //    if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
        //    {
        //        cmdresult = 0;
        ...
        /// <summary>    
        /// 执行SQL语句，返回影响的记录数     执行增删 改
        /// </summary>    
        /// <param name="SQLString">SQL语句</param>    
        /// <returns>影响的记录数</returns>    
        public override int Update (string SQLString)
        {
            lock (_syncObject)
            {
        ...
        public override bool UpdateByTran(IEnumerable SQLStringList)
        {
            lock (_syncObject)
            {
                using (OleDbConnection conn = new OleDbConnection(connectionString))
                {
                    ...
                    try
                    {
                        foreach (var StringList in SQLStringList)
                        {
                            string strsql = StringList.ToString();
        ...
        public override object GetSingleResult(string SQLString)
        {
            lock (_syncObject)
            {
                using (OleDbConnection connection = new OleDbConnection(connectionString))
        ...
        /// <param name="SQLString">SQL语句</param>    
        /// <returns>影响的记录数</returns>    
        public override int Update(string SQLString, params DbParameter[] cmdParms)
        {
            lock (_syncObject)
            {
                using (OleDbConnection connection = new OleDbConnection(connectionString))
        ...
        /// <param name="SQLString">计算查询结果语句</param>    
        /// <returns>查询结果（object）</returns>    
        public override object GetSingleResult(string SQLString, params DbParameter[] cmdParms)
        {
            lock (_syncObject)
            {
                using (OleDbConnection connection = new OleDbConnection(connectionString))
        ...
        //    object obj = AccessDBHelper.GetSingleResult(sql);
        //    if (obj == null)
        //    {
        //        return 1;
        //    }
        ...
        public static bool CheckExitColum(string tableName, string columName)
        {
            lock (_syncObject)
            {
                using (OleDbConnection connection = new OleDbConnection(connectionString))
